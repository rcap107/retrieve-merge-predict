...
--query_column col_to_embed --sampling_seed 42 --iterations 750 --top_k 100  --join_strategy nojoin wordnet_big
# companies nojoin
...
python main_pipeline.py --source_table_path data/source_tables/ken_datasets/presidential-results/presidential-results-prepared.parquet \
--query_column col_to_embed --sampling_seed 42 --iterations 750 --top_k 100  --join_strategy left wordnet_big
# company left no agg
python main_pipeline.py --source_table_path data/source_tables/ken_datasets/company-employees/company-employees-prepared.parquet \
--query_column col_to_embed --sampling_seed 42 --iterations 750 --top_k 100  --join_strategy left wordnet_big
# movies left no agg
...
python main_pipeline.py --source_table_path data/source_tables/ken_datasets/presidential-results/presidential-results-prepared.parquet \
--query_column col_to_embed --sampling_seed 42 --iterations 750 --top_k 100  --join_strategy left --aggregation dedup wordnet_big
...
python main_pipeline.py --source_table_path data/source_tables/ken_datasets/presidential-results/presidential-results-prepared.parquet \
--query_column col_to_embed --sampling_seed 42 --iterations 750 --top_k 100  --join_strategy left --aggregation dfs wordnet_big
# companies left dfs
python main_pipeline.py --source_table_path data/source_tables/ken_datasets/company-employees/company-employees-prepared.parquet \
--query_column col_to_embed --sampling_seed 42 --iterations 750 --top_k 100  --join_strategy left --aggregation dfs wordnet_big
# movies left dfs
